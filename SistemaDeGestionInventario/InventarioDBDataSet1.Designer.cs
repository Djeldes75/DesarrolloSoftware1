...
namespace InventarioApp.InventarioDBDataSet1TableAdapters {
    ...
    public partial class ProveedoresTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Proveedores] WHERE (([IDProveedor] = @Original_IDProveedor) AND ([NombreEmpresa] = @Original_NombreEmpresa) AND ((@IsNull_Contacto = 1 AND [Contacto] IS NULL) OR ([Contacto] = @Original_Contacto)) AND ((@IsNull_Direccion = 1 AND [Direccion] IS NULL) OR ([Direccion] = @Original_Direccion)) AND ((@IsNull_Telefono = 1 AND [Telefono] IS NULL) OR ([Telefono] = @Original_Telefono)))";
...
SELECT IDProveedor, NombreEmpresa, Contacto, Direccion, Telefono FROM Proveedores WHERE (IDProveedor = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Proveedores] SET [NombreEmpresa] = @NombreEmpresa, [Contacto] = @Contacto, [Direccion] = @Direccion, [Telefono] = @Telefono WHERE (([IDProveedor] = @Original_IDProveedor) AND ([NombreEmpresa] = @Original_NombreEmpresa) AND ((@IsNull_Contacto = 1 AND [Contacto] IS NULL) OR ([Contacto] = @Original_Contacto)) AND ((@IsNull_Direccion = 1 AND [Direccion] IS NULL) OR ([Direccion] = @Original_Direccion)) AND ((@IsNull_Telefono = 1 AND [Telefono] IS NULL) OR ([Telefono] = @Original_Telefono)));
SELECT IDProveedor, NombreEmpresa, Contacto, Direccion, Telefono FROM Proveedores WHERE (IDProveedor = @IDProveedor)";
        ...
        public virtual int Fill(InventarioDBDataSet1.ProveedoresDataTable dataTable) {
        ...
        public virtual InventarioDBDataSet1.ProveedoresDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            InventarioDBDataSet1.ProveedoresDataTable dataTable = new InventarioDBDataSet1.ProveedoresDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(InventarioDBDataSet1.ProveedoresDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(InventarioDBDataSet1 dataSet) {
